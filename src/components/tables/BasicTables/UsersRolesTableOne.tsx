        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                <span className="font-medium">Rôle :</span> {selectedUserRole.name}
              </p>
              <p className="text-gray-600 dark:text-gray-400">
                <span className="font-medium">Date de création :</span> {moment(selectedUserRole.createdAt).format("DD/MM/YYYY HH:mm:ss")}
              </p>
            </div>
