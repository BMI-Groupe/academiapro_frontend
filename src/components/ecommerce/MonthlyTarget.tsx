    ...
    <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
      <div className="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
          ...
          <div className="relative inline-block">
            <button className="dropdown-toggle" onClick={toggleDropdown}>
              <p className="flex items-center justify-center mt-1 gap-1 text-gray-500 text-theme-sm dark:text-gray-400">
                01/01/25 <CalenderIcon className="text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 size-6"> </CalenderIcon>
              </p>
        ...
        <p className="mx-auto mt-10 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
          Vous avez traité 5 cas de plus aujourd'hui, c'est bien plus qu'hier. Continuez votre bon travail!
        </p>
      </div>
